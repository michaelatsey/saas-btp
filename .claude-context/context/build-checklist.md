...
- [ ] 1.4 ADR-PROD-001 (market entry = Safety, Ivorian market rationale)
- [ ] 1.5 ADR-ARCH-002 (CorrectiveActions as a separate bounded context)
- [ ] 1.6 Adjust product-vision.md (remove "backlog.md canonical" mention)
- [ ] 1.7 Delete backlog.md
- [ ] 1.8 Commit `docs(scope): define Phase 1 + bounded contexts` + push (on dev)

---

## Step 2 — Tracker foundation (GitHub Issues, reusable)

- [ ] 2.1 Issues convention in repo (title format, labels, DoR/DoD)
- [ ] 2.2 Create labels via gh (ctx:safety, ctx:corrective-actions, type:story, prio:*, offline...)
...
- [ ] 2.6 Commit `chore(repo): issues convention + templates` + push
...
Step 1 in progress. Remaining in Step 1: ADR-PROD-001, ADR-ARCH-002, adjust
product-vision.md, delete backlog.md, then commit on dev.
